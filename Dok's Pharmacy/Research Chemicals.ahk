...
*/
/*
ABLETON HORIZONTAL SCROLL WITH MOUSE WHEEL
*/
...
;
^!+t::							 
	MsgBox, 0, This is only a test!, Research Chemicals is running!`n`n`nYES !!!!!!!!!!!!!!!!!!!!!!!!!!!!`n`n`nYou Pressed [CTRL+ALT+SHIFT+T]
	return
...
#IfWinActive
/*****************************************************************************************************************************************************************************
;	4.	DEVELOPMENT SHORTCUT HOTSTRINGS
****************************************************************************************************************************************************************************
*/
#IfWinActive SciTE	;	The following hotstrings will work while the SciTE4Autohotkey editor application is running
/*	HOTSTRING: INSERT MENU HEADER WITH m.
***********************************************************************************************
*/
;	INSERT MENU HEADER 	[m.]
	::m.::
		Send {raw}/*****************************************************************************************************************************************************************************`n;		`n;		`n;		`n****************************************************************************************************************************************************************************`n*/`n
		return
;
/*	HOTSTRING: INSERT SHORT LINE BREAK WITH b.
***********************************************************************************************
*/
;	INSERT SHORT LINE BREAK		[b.]
	::b.::	
		Send {raw}/***********************************************************************************************`n*/`n
		return
;

/*		HOTSTRING: INSERT LONG LINE BREAK WITH bb.
**********************************************************************************************
*/
;	INSERT LONG LINE BREAK		[bb.]
	::bb.::
		Send {raw};****************************************************************************************************************************************************************************
		return
;
/*
;	HOTSTRING: INSERT COMMENTS BRACKET WITH c. 
*/
;	INSERT BLOCK COMMENTS BOX	[c.]
	::c.::
		Send /*`n`n`n*/ 	
		return
;
