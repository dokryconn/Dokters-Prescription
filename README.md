...
_[Go to the **Optional Hotkeys** section](#Optional-Dokters-Prescription-Hotkeys) below for the complete list of optional hotkey template code included in "Dok's Rx Pad.AHK"_
