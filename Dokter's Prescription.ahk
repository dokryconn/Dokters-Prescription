...
*/
;	
FileCreateDir, %A_ScriptDir%\Dok's Rx Cabinet			;	CREATES THE ROOT FOLDER THAT CONTAINS THE FILES/SCRIPTS USED FOR THIS COMPILED .EXE SCRIPT
;
...
/***********************************************************************************************
*/
;	Installs Dok's Rx Pad AHK script, icon files, `App Launch Shortcuts` folder, and RxEAD ME files:
...
FileInstall, Dok's Pharmacy\RxEAD ME.md,%A_WorkingDir%\RxEAD ME.md
FileInstall, Dok's Pharmacy\RxEAD ME.doc,%A_WorkingDir%\RxEAD ME.doc
...
Menu, Tray, Tip, Dokter's Prescription`nYou are in a simulation!
return
...
;	[CTRL+S]
;
 #IfWinActive Dokter's Prescription.ahk	; !!~~~	INSERT SCRIPT NAME HERE AND IN THE MSGBOX BELOW	~~~!!	
^s:: 									; [CTRL+S] (SAVE)
	Send ^s 								
